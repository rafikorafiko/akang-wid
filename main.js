    ...
    m.exp += 1
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        try {
          ...
          if (m.limit) m.reply(+ m.limit + ' Limit terpakai, Untung bukan dosa')
        }
  			break
  		}
  	}
...
conn.welcome = 'Asikkk ada beban keluarga masuk🥳 @user!\nSelamat datang di grup @subject\n\nJika sudah nyaman jangan di tinggal ya anjing😠*'
conn.bye = 'Sayonara👋, Terimakasih selalu ada💓@user!'
